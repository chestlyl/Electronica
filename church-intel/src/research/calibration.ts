...
export function toolFieldsFromBuild(target: ResearchTarget, build: DossierBuild): FieldMap {
  ...
  return {
    ...
    lead_pastor: { value: s.lead_pastor, confidence: capc(fe.lead_pastor?.confidence) },
    ...
    multi_site: { value: null, confidence: null },
    campus_count: { value: null, confidence: null },
    lifecycle_stage: { value: s.lifecycle_stage, confidence: capc(fe.lifecycle_stage?.confidence) },
    founded_year: { value: null, confidence: null },
    ...
    staff_count: { value: null, confidence: null },
    annual_budget: { value: null, confidence: null },
    church_app_status: { value: s.church_app_status, confidence: capc(60) },
    app_provider: { value: s.app_provider, confidence: capc(40) },
    ...
    online_giving_present: { value: null, confidence: null },
